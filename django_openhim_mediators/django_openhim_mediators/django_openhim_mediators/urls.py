...
from family_mediator.views import getFamily
...
from family_mediator.views import registerFamilyMediator
...
urlpatterns = [
    ...
    path('api/api_fhir_r4/Group', getFamily),
