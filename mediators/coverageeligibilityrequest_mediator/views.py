...
def getCoverageEligibilityRequest(request):
	...
	url = configurations["data"]["openimis_url"]+":"+str(configurations["data"]["openimis_port"])+"/api/api_fhir_r4/CoverageEligibilityRequest"
...
def registerCoverageEligibilityRequestMediator():
	...
	"defaultChannelConfig": [
		{
			"name": "Python Fhir R4 CoverageEligibilityRequest Mediator",
			"urlPattern": "^/api/api_fhir_r4/CoverageEligibilityRequest$",
			"routes": [
				{
