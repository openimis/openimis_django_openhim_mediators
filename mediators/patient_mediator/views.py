"""
Settings for openhim person mediator developed in Django.

The python-based person mediator implements python-utils 
...
def getPatient(request):
	...
	if request.method == 'GET':
		url = "http://104.248.143.105:8000/api/api_fhir_r4/Patient"
		querystring = {"":""}
		payload = ""
